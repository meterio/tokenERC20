...
export interface NonblockingLzAppUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface NonblockingLzAppUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): NonblockingLzAppUpgradeable;
