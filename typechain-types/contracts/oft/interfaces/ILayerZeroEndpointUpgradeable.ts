...
export interface ILayerZeroEndpointUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "estimateFees"
      | "forceResumeReceive"
...
export interface ILayerZeroEndpointUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): ILayerZeroEndpointUpgradeable;
