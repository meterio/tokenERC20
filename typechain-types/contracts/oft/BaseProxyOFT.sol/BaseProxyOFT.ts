...
export interface BaseProxyOFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface BaseProxyOFT extends BaseContract {
  connect(runner?: ContractRunner | null): BaseProxyOFT;
  waitForDeployment(): Promise<this>;

  interface: BaseProxyOFTInterface;
