...
export interface OFTCoreUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
...
export interface OFTCoreUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): OFTCoreUpgradeable;
