...
interface ERC20MintablePauseableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC20MintablePauseable extends Contract {
  ...
  interface: ERC20MintablePauseableInterface;
