...
interface MeterGovERC20UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class MeterGovERC20Upgradeable extends Contract {
  ...
  interface: MeterGovERC20UpgradeableInterface;
