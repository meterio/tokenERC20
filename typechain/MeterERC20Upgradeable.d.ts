...
interface MeterERC20UpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class MeterERC20Upgradeable extends Contract {
  ...
  interface: MeterERC20UpgradeableInterface;
