...
interface MeterERC20MintablePauseableInterface extends ethers.utils.Interface {
  functions: {
...
export class MeterERC20MintablePauseable extends Contract {
  ...
  interface: MeterERC20MintablePauseableInterface;
